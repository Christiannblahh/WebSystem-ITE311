...
<head>
    ...
    <style>
        .auth-wrapper { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #fafafa; }
        .auth-card { width: 420px; background: #fff; border: 1px solid #e9ecef; border-radius: 16px; padding: 32px; box-shadow: 0 10px 30px rgba(16,24,40,.06); }
        .auth-title { font-weight: 700; font-size: 40px; line-height: 1.1; margin-bottom: 8px; }
        .auth-subtitle { color: #475467; margin-bottom: 28px; }
        ...
        .login-arrow { width: 18px; height: 18px; margin-left: 6px; }
        .auth-footer { text-align: center; color: #475467; margin-top: 18px; }
        ...
        <div class="auth-card">
            ...
            <form action="<?= site_url('/login') ?>" method="post" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control input-lg" placeholder="you@example.com" value="<?= set_value('email') ?>" required>
                </div>

                <div class="mb-1">
                    <label class="form-label">Password</label>
                    <input type="password" name="password" class="form-control input-lg" placeholder="••••••••" required>
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100 mt-3 d-flex align-items-center justify-content-center">
                    Log in
                    <svg class="login-arrow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
